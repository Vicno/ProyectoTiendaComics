...
CREATE TABLE comic (
  ...
  codigoEspecial int(11) DEFAULT NULL,
...
--
ALTER TABLE comic
ADD CONSTRAINT FK_comic_tipoespecial_codigoEspecial FOREIGN KEY (codigoEspecial)
...
(1, '1', 1, 2001, '1', '1', 1, NULL),
(2, '2', 2, 2002, '2', '2', 2, NULL),
(4, '4', 4, 2004, '4', '4', 4, NULL),
(6, '6', 6, 2006, '6', '6', 6, NULL),
(14, '14', 14, 2014, '14', '14', 5, NULL),
(25, '25', 25, 2025, '25', '25', 25, NULL),
(35, 'para ver', 89, 1999, '47', 'para ver si muestra bien', 47, NULL),
(48, '48', 48, 2048, '48', '48', 48, NULL),
(69, '69', 69, 2069, '69', '96', 69, NULL),
(85, '85', 85, 1985, '85', '85', 85, NULL),
(202, '202', 202, 2020, '202', '202', 202, NULL),
(2020, '2020', 20, 2000, 'fefe', 'preubas', 87, NULL),
(9898, '8989', 8484, 2057, '21', '54', 20, NULL);
